...
ID 10: Usei no HTML o atributo required para validação de campos obrigatórios, e as mensagens de erro são exibidas nas <div> com a classe error, que são preenchidas pelo JavaScript.
